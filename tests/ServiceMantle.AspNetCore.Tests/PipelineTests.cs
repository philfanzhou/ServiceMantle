...
public sealed class PipelineTests
{
        ...
        string composition = "normal", ServiceHealthSnapshot? snapshot = null)
    {
        ...
        app.Use(async (context, next) =>
        {
            ...
            var projector = context.RequestServices.GetRequiredService<RequestHeaderDiagnosticProjector>();
        ...
        app.MapGet("/limited", () => Results.Ok()).RequireRateLimiting(RateLimitingDefaults.ManagementPolicyName)
    ...
    private static string Cookie(WebApplication app, string id, ManagementPermission permission)
    {
        ...
        return ManagementSessionDefaults.CookieName + "=" + options.TicketDataFormat.Protect(ticket);
    }
