...
public sealed class ServiceMantleAuditQueryEndpointTests
{
    ...
    public async Task Invalid_unknown_repeated_empty_or_out_of_range_input_never_calls_the_service(string query)
    {
        ...
        Assert.Contains(ServiceMantleManagementApiDefaults.InvalidRequestErrorCode, body, StringComparison.Ordinal);
