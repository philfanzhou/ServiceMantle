...
public sealed class SecurityResponseHeadersTests
{
    ...
    public async Task Registration_is_idempotent_marker_is_deduplicated_and_no_options_are_exported()
    {
        ...
        Assert.Single(endpoint.Metadata.OfType<SecurityResponseHeadersMetadata>());
        Assert.DoesNotContain(
            typeof(SecurityResponseHeadersMetadata).Assembly.ExportedTypes,
    ...
    public async Task Middleware_registers_one_callback_for_one_marked_request()
    {
        ...
        context.SetEndpoint(new Endpoint(
            ...
            new EndpointMetadataCollection(new SecurityResponseHeadersMetadata()),
            "marked"));
