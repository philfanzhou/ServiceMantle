...
/// </summary>
public sealed class PhaseGateCancellationTests
{
    ...
    private static async Task<WebApplication> StartAsync(IServiceHealthSnapshotSource source, Executions executions,
        HandlerObservation? observation = null, Action<PhaseGateOptions>? configure = null,
        bool kestrel = false, CancellationTokenSource? serverAbort = null)
    {
        ...
        management.MapGet("/status", () => executions.Run("status")).WithServiceMantleManagementSurface(ManagementSurface.Status);
        management.MapGet("/bootstrap", () => executions.Run("bootstrap")).WithServiceMantleManagementSurface(ManagementSurface.Bootstrap);
        management.MapGet("/setup", () => executions.Run("setup")).WithServiceMantleManagementSurface(ManagementSurface.Setup);
        management.MapGet("/settings", () => executions.Run("settings")).WithServiceMantleManagementSurface(ManagementSurface.Management);
