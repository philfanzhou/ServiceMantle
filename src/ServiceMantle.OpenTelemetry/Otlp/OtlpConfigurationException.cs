...
public sealed class OtlpConfigurationException : InvalidOperationException
{
    internal OtlpConfigurationException(string fieldName, string errorCode)
    ...
    public override string ToString() =>
        $"OtlpConfigurationException(FieldName={FieldName}, ErrorCode={ErrorCode})";
}
