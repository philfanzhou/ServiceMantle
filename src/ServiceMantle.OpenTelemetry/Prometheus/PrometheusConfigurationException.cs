...
public static class WellKnownPrometheusErrorCodes
{
...
public sealed class PrometheusConfigurationException : Exception
{
    internal PrometheusConfigurationException(string errorCode, string fieldName)
    ...
    public override string ToString() =>
        $"PrometheusConfigurationException(ErrorCode={ErrorCode}, FieldName={FieldName})";
}
