...
{
    /// <summary>The supplied XML is not a supported Data Protection repository element.</summary>
    public const string InvalidElement = "data_protection_keys.invalid_element";

    /// <summary>The repository element identifier already exists for this service.</summary>
    ...
    /// <summary>A stored repository element could not be authenticated, decrypted, or parsed.</summary>
