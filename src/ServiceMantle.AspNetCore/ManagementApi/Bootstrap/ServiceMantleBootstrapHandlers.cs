...
/// </para>
/// </remarks>
internal static class ServiceMantleBootstrapHandlers
{
    ...
    internal static async Task<IResult> CreateAsync(HttpContext context)
    {
        ...
        {
            return ServiceMantleBootstrapResult.CredentialInvalid;
        }

        var store = context.RequestServices.GetService<IBootstrapCredentialStore>();
        if (store is null)
        {
            return ServiceMantleBootstrapResult.Unavailable;
        }
        ...
        if (!consumption.IsConsumed)
        {
            ...
            return string.Equals(
                ...
                ? ServiceMantleBootstrapResult.CredentialInvalid
                : ServiceMantleBootstrapResult.Unavailable;
        }
        ...
        return await PublishAsync(
            ...
            ServiceMantleBootstrapResult.Created).ConfigureAwait(false);
    }
    ...
    internal static async Task<IResult> UpdateAsync(HttpContext context)
    {
        ...
        return await PublishAsync(
            ...
            () => manager.UpdateAsync(
                ...
                context.RequestAborted),
            ServiceMantleBootstrapResult.Updated).ConfigureAwait(false);
    }

    private static async ValueTask<ServiceMantleBootstrapRequest?> ParseAsync(
        HttpContext context,
        bool requireBoth)
    {
        ServiceMantleBootstrapRequest? parsed;
        try
        {
            parsed = await ServiceMantleBootstrapRequestParser
        ...
        IResult success)
    {
        ...
        catch (BootstrapManagementException exception)
        {
            ...
            return ServiceMantleBootstrapMapping.IsUnavailableCode(exception.ErrorCode)
                ? ServiceMantleBootstrapResult.Unavailable
        ...
        context.RequestServices.GetRequiredService<ServiceMantleBootstrapRestartLatch>().Latch();
        ObserveCallerCancellation(context);
        return success;
    }
    ...
    {
        candidate = null;
        var values = context.Request.Headers[ServiceMantleBootstrapMapping.CredentialHeaderName];
        if (values.Count != 1)
        {
            return false;
        }
