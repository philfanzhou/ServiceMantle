...
/// </remarks>
internal sealed class ServiceMantleBootstrapRequest
{
    internal ServiceMantleBootstrapRequest(
    ...
    public override string ToString() =>
        $"ServiceMantleBootstrapRequest(DatabaseProvided={Database is not null}, " +
...
/// </para>
/// </remarks>
internal static class ServiceMantleBootstrapRequestParser
{
    ...
    private static readonly JsonDocumentOptions DocumentOptions = new()
    {
        ...
        MaxDepth = ServiceMantleBootstrapMapping.MaximumJsonDepth,
    };
    ...
    /// </param>
    internal static async ValueTask<ServiceMantleBootstrapRequest?> ParseAsync(
        HttpContext context,
        bool requireBoth)
    {
        ...
        if (request.QueryString.HasValue ||
            ...
            request.ContentLength is > ServiceMantleBootstrapMapping.MaximumBodyLength)
        {
            return null;
        }

        var body = new ArrayBufferWriter<byte>();
        var rented = ArrayPool<byte>.Shared.Rent(ServiceMantleBootstrapMapping.MaximumBodyLength);
        try
        {
            while (true)
            {
                var remaining = ServiceMantleBootstrapMapping.MaximumBodyLength - body.WrittenCount;
    ...
    private static ServiceMantleBootstrapRequest? Parse(ReadOnlyMemory<byte> body, bool requireBoth)
    {
        ...
        try
        {
            ...
            return new ServiceMantleBootstrapRequest(parsedDatabase, parsedMasterKey);
        }
        catch (JsonException)
        {
            return null;
