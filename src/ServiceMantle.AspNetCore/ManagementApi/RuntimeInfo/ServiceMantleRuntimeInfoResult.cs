...
/// </remarks>
internal sealed class ServiceMantleRuntimeInfoResult : IResult
{
    ...
    private ServiceMantleRuntimeInfoResult(byte[] body)
    {
        this.body = body;
    }

    internal static ServiceMantleRuntimeInfoResult Create(ServiceLogContext logContext)
    {
        ...
        writer.Flush();
        return new ServiceMantleRuntimeInfoResult(buffer.WrittenSpan.ToArray());
    }
