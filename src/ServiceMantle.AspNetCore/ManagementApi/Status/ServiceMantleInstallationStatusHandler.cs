...
/// </remarks>
internal static class ServiceMantleInstallationStatusHandler
{
    internal static async Task<IResult> HandleAsync(
        HttpContext context,
        IServiceMantleBootstrapStatusReader bootstrap,
        ...
        TimeSpan budget)
    {
        ...
        if (snapshot is null)
        {
            return ServiceMantleInstallationStatusResult.Unavailable;
        }
        ...
        return IsCoherent(snapshot.Phase, bootstrapConfigured, restartRequired)
            ? ServiceMantleInstallationStatusResult.Create(snapshot, bootstrapConfigured, restartRequired)
            : ServiceMantleInstallationStatusResult.Unavailable;
    }
