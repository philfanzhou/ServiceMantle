...
/// </remarks>
internal sealed class InstallationStatusResult : IResult
{
    /// <summary>
    ...
    /// </summary>
    internal static readonly InstallationStatusResult Unavailable = new(
        Encoding.UTF8.GetBytes(
            "{\"errorCode\":\"" + InstallationStatusMapping.UnavailableErrorCode + "\"}"),
        StatusCodes.Status503ServiceUnavailable);

    private readonly byte[] body;
    private readonly int statusCode;

    private InstallationStatusResult(byte[] body, int statusCode)
    {
        this.body = body;
    ...
    /// </summary>
    internal static InstallationStatusResult Create(
        ...
        bool restartRequired)
    {
        ...
        return new InstallationStatusResult(
