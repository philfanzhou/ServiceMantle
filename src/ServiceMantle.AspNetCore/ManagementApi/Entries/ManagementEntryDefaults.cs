...
/// </remarks>
public enum ManagementEntryKind
{
...
/// </summary>
public static class ManagementEntryDefaults
{
    /// <summary>
    ...
    internal static ManagementEntryDefinition Get(ManagementEntryKind kind) =>
        kind switch
        {
            ManagementEntryKind.InstallationStatus => new(
                kind,
                StatusPath,
                ReadMethods,
                ManagementSurface.Status,
            ...
            ManagementEntryKind.BootstrapCreate => new(
                kind,
                BootstrapPath,
                PostMethods,
                ManagementSurface.Bootstrap,
                AuthorizationPolicyName: null,
                RateLimitingDefaults.SetupPolicyName,
                AnonymousClientPartition: false,
                RequiresUnsafeRequestHeader: true),
            ManagementEntryKind.BootstrapUpdate => new(
                kind,
                BootstrapPath,
                PutMethods,
                ManagementSurface.Bootstrap,
            ...
            ManagementEntryKind.SetupStatus => new(
                kind,
                SetupPath,
                ReadMethods,
                ManagementSurface.Setup,
                AuthorizationPolicyName: null,
                RateLimitingDefaults.SetupPolicyName,
                AnonymousClientPartition: false,
                RequiresUnsafeRequestHeader: false),
            ManagementEntryKind.SetupComplete => new(
                kind,
                SetupPath,
                PostMethods,
                ManagementSurface.Setup,
                ...
                AnonymousClientPartition: false,
                RequiresUnsafeRequestHeader: true),
            ManagementEntryKind.SessionLogin => new(
                kind,
                SessionLoginPath,
                PostMethods,
                ...
                AnonymousClientPartition: false,
                RequiresUnsafeRequestHeader: true),
            ManagementEntryKind.SessionLogout => new(
                kind,
                SessionLogoutPath,
                PostMethods,
                ManagementSurface.Management,
                ...
                AnonymousClientPartition: false,
                RequiresUnsafeRequestHeader: true),
            ManagementEntryKind.CurrentSession => new(
                kind,
                SessionPath,
                ReadMethods,
                ManagementSurface.Management,
...
internal sealed record ManagementEntryDefinition(
...
internal sealed record ManagementEntryMetadata(ManagementEntryKind Kind);

/// <summary>Marks an entry that carries the fixed unsafe-request header guard.</summary>
internal sealed record UnsafeRequestGuardMetadata;
