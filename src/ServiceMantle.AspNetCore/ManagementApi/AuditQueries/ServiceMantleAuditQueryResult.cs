...
/// </summary>
internal sealed class ServiceMantleAuditQueryResult : IResult
{
    internal static readonly ServiceMantleAuditQueryResult Unavailable = new(
        Encoding.UTF8.GetBytes(
            "{\"errorCode\":\"" + ServiceMantleAuditQueryMapping.UnavailableErrorCode + "\"}"),
        StatusCodes.Status503ServiceUnavailable);

    private readonly byte[] body;
    private readonly int statusCode;

    private ServiceMantleAuditQueryResult(byte[] body, int statusCode)
    {
        this.body = body;
        this.statusCode = statusCode;
    }

    internal static ServiceMantleAuditQueryResult Success(ManagementAuditQueryResult result)
    {
        ...
        return new ServiceMantleAuditQueryResult(buffer.WrittenSpan.ToArray(), StatusCodes.Status200OK);
    }
