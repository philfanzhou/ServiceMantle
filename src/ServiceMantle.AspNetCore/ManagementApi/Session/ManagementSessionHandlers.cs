...
/// </remarks>
internal static class ManagementSessionHandlers
{
    /// <summary>
        ...
        TimeSpan loginTimeout)
    {
        ...
        if (request.QueryString.HasValue ||
            ...
            request.ContentLength > ManagementSessionMapping.MaximumLoginBodyLength)
        {
        ...
        using var body = await ManagementSessionBodyAdmission
        ...
        switch (body.Status)
        {
            case ManagementSessionBodyAdmission
                .ManagementSessionBodyStatus.Rejected:
                ...
                return ManagementApiResults.InvalidRequest();
            case ManagementSessionBodyAdmission
                .ManagementSessionBodyStatus.Unavailable:
        ...
        {
            return ManagementSessionResult.Unauthenticated;
        }
    ...
    private static async ValueTask<ManagementIdentityResult?> InvokeAsync(
        HttpContext context,
        ManagementLoginAdapter adapter,
        ManagementSessionBodyAdmission body,
    ...
    internal static async Task<IResult> CurrentAsync(HttpContext context)
    {
        ...
        try
        {
            ...
            authentication = await context
                .AuthenticateAsync(ManagementSessionDefaults.AuthenticationScheme)
                .ConfigureAwait(false);
        }
        catch
        {
        ...
        return authentication.Succeeded && authentication.Properties?.ExpiresUtc is { } expiresUtc
            ? ManagementSessionResult.Current(resolution.Identity, expiresUtc)
    ...
    internal static async Task<IResult> LogoutAsync(HttpContext context)
    {
        ...
        try
        {
            ...
            await context
                .SignOutAsync(ManagementSessionDefaults.AuthenticationScheme)
                .ConfigureAwait(false);
        }
        catch
        {
