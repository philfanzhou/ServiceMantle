...
public sealed class SensitiveHeaderConfigurationException : Exception
{
    internal SensitiveHeaderConfigurationException(string errorCode, string fieldName)
    ...
    public override string ToString() =>
        $"SensitiveHeaderConfigurationException(ErrorCode={ErrorCode}, FieldName={FieldName})";
}
