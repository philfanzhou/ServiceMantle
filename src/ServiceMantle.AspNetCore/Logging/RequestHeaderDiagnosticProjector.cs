...
{
    internal SensitiveHeaderSanitizer(SensitiveHeaderRegistry registry)
    {
...
/// </summary>
public sealed class RequestHeaderDiagnosticProjector
{
    private readonly StructuredLogSanitizer sanitizer;

    internal RequestHeaderDiagnosticProjector(
        SensitiveHeaderSanitizer ownedSanitizer)
    {
