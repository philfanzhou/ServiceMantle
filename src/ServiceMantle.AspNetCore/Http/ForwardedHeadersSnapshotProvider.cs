...
internal sealed record ForwardedHeadersRegistration(
    ForwardedHeadersTrustOptions Options);

internal sealed class ForwardedHeadersSnapshotProvider(
    IEnumerable<ForwardedHeadersRegistration> registrations)
{
    ...
    private static NormalizedConfiguration Normalize(ForwardedHeadersTrustOptions options)
    {
    ...
    private static ForwardedHeadersConfigurationException Failure(
        string errorCode,
