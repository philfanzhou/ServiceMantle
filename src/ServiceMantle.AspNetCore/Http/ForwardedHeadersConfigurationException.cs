...
public sealed class ForwardedHeadersConfigurationException : Exception
{
    internal ForwardedHeadersConfigurationException(string errorCode, string fieldName)
    ...
    public override string ToString() =>
        $"ForwardedHeadersConfigurationException(ErrorCode={ErrorCode}, FieldName={FieldName})";
}
