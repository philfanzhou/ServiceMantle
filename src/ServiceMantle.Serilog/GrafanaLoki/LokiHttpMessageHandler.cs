...
internal interface ILokiHttpMessageHandlerFactory
{
    HttpMessageHandler Create();
}

internal sealed class LokiHttpMessageHandlerFactory : ILokiHttpMessageHandlerFactory
{
    ...
    GrafanaLokiDeliveryCounter deliveryCounter) : DelegatingHandler(innerHandler)
{
        ...
        CancellationToken cancellationToken)
    {
        ...
        {
            throw new LokiDeliveryException(
...
internal sealed class GrafanaLokiDeliveryCounter
{
...
internal sealed class LokiDeliveryException(string errorCode) : HttpRequestException
{
    ...
    public override string ToString() =>
        $"LokiDeliveryException(ErrorCode={ErrorCode})";
}
