...
Product identity also does not prove that target and administrative connections reach the same
server instance; [#223](https://github.com/philfanzhou/ServiceMantle/issues/223) tracks that contract.
